...
class ConvexLens extends Lens {
	...
	public ConvexLens(int x, int y, int focus) {
		super(x, y, focus, "convexLens.png");
	}
...
//		if((angleBetween>=65 && 115>=angleBetween) || (angleBetween>=-115 && -65>=angleBetween)|| (angleBetween>=-295 && -245>=angleBetween)|| (angleBetween>=245 && 295>=angleBetween)){
//			return new Ray(0,600,0,this);
//		}
...
//				dCy = Math.tan(Math.toRadians(rayAngle))*(dCx-xBound)+yBound;
	...
	System.out.println("case11");
					...
					newAngle = -( Math.toDegrees(Math.atan( (dGy-yBound)/(dGx-xBound)) )); 
